...
def get_trainloader(size_batch=64):
    ...
    trainloader = torch.utils.data.DataLoader(
        train_set, batch_size=size_batch, shuffle=True)
...
def get_valloader(size_batch=64):
    ...
    valloader = torch.utils.data.DataLoader(
        val_set, batch_size=size_batch, shuffle=True)
...
def get_testloader(size_batch=64):
    ...
    testloader = torch.utils.data.DataLoader(
        test_set, batch_size=size_batch, shuffle=True)
...
def process_image(image):
    ...
    left, top, right, bottom = center[0]-(244/2), center[1]-(
        244/2), center[0]+(244/2), center[1] + (244/2)
